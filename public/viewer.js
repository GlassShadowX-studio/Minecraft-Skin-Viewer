...
function buildModel(canvas, isSlim, capeCanvas) {
    ...
    const lArmFaces = isLegacySkin
        ...
        : [ 
            ...
            { o3: [hw, 0, -2], uA: [-1, 0, 0], vA: [0, -1, 0], n: [0, 0, -1], uv: [44, 52], s: [armW, 12], uvO: [60, 52], baseOffset: BO, overlayOffset: OO },
            { o3: [-hw, 0, 2], uA: [0, 0, -1], vA: [0, -1, 0], n: [-1, 0, 0], uv: [32, 52], s: [4, 12], uvO: [48, 52], baseOffset: BO, overlayOffset: OO },
            { o3: [hw, 0, -2], uA: [0, 0, 1], vA: [0, -1, 0], n: [1, 0, 0], uv: [40, 52], s: [4, 12], uvO: [56, 52], baseOffset: BO, overlayOffset: OO },
            { o3: [-hw, 0, 2], uA: [1, 0, 0], vA: [0, 0, -1], n: [0, 1, 0], uv: [36, 48], s: [armW, 4], uvO: [52, 48], baseOffset: BO, overlayOffset: OO },
            { o3: [-hw, -12, -2], uA: [1, 0, 0], vA: [0, 0, 1], n: [0, -1, 0], uv: [40, 48], s: [armW, 4], uvO: [56, 48], baseOffset: BO, overlayOffset: OO }
          ];
